...
--
-- Name: councilbox; Type: DATABASE; Schema: -; Owner: psqladmin
--

CREATE DATABASE councilbox WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'English_United States.1252';


ALTER DATABASE councilbox OWNER TO psqladmin;
...
--
-- Name: DATABASE councilbox; Type: COMMENT; Schema: -; Owner: psqladmin
--

COMMENT ON DATABASE councilbox IS 'councilbox mvp2';
...
--
-- Name: DATABASE councilbox; Type: ACL; Schema: -; Owner: psqladmin
--

GRANT ALL ON DATABASE councilbox TO councilbox;
GRANT CONNECT ON DATABASE councilbox TO councilbox_readonly;
